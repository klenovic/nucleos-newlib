...
char _EXFUN(*realpath, (const char *path, char *resolved_path));

/* Return the value of envariable NAME, or NULL if it doesn't exist.  */
char _EXFUN(*getenv,(__const char *__name));

/* This function is similar to the above but returns NULL if the
   programs is running with SUID or SGID enabled.  */
char _EXFUN(*__secure_getenv,(__const char *__name));
...
int _EXFUN(setenv,(__const char *__name, __const char *__value, int __replace));

/* Remove the variable NAME from the environment.  */
int _EXFUN(unsetenv,(__const char *__name));
#endif
